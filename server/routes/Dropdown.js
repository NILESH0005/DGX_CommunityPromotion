...
import { getDropdownValues, getQuizGroupDropdown, getQuizDropdown, getQuestionGroupDropdown, getModules, getSubModules, getUnitsWithFiles, getModuleById, getSubModulesTo } from '../controllers/dropdown.js';  // Make sure the path is correct
...
router.get('/getSubModulesTo', getSubModulesTo);
