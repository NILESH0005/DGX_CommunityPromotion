...
const AddSubmodulePopup = ({ moduleId, onClose, onSave }) => {
    ...
    const validateForm = () => {
        ...
        if (formData.SubModuleDescription.length > 500) {
            newErrors.SubModuleDescription = "Description must be less than 500 characters";
        }
            ...
            <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden animate__animated animate__fadeInUp">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    ...
                    <div className="relative group">
                        <div className={`h-48 border-2 border-dashed rounded-lg overflow-hidden transition-all 
                            ${errors.image ? 'border-red-500' : 'border-gray-300 hover:border-blue-400'} 
                            ...
                            {imagePreview ? (
                                ...
                                <div className="h-full flex flex-col items-center justify-center p-4 text-center">
                                    ...
                                    <p className="text-gray-500 mb-3">Drag & drop an image or click to browse</p>
                                    <p className="text-xs text-gray-400 mb-3">Max size: 200KB (JPEG, PNG)</p>
                                    <input
                                        type="file"
                                        ref={fileInputRef}
                    ...
                    <div className="space-y-1">
                        <label htmlFor="SubModuleName" className="block text-sm font-medium text-gray-700">
                        ...
                        <input
                            ...
                            className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all
                                ${errors.SubModuleName ? 'border-red-500' : 'border-gray-300'}`}
                    ...
                    {/* Description Field */}
                    <div className="space-y-1">
                        <label htmlFor="SubModuleDescription" className="block text-sm font-medium text-gray-700">
                            Description
                        </label>
                        <textarea
                            ...
                            rows={3}
                            className={`w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all
                                ${errors.SubModuleDescription ? 'border-red-500' : 'border-gray-300'}`}
