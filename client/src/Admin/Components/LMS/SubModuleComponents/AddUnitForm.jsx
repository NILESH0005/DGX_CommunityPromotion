                    ...
                    {/* <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-4">
                            <motion.label 
                                ...
                                } flex items-center justify-center cursor-pointer bg-DGXgray/10 relative group`}
                            >
                                {newUnit.UnitImgPreview ? (
                                    <>
                                        <img 
                                        ...
                                        <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 flex items-center justify-center transition-opacity">
                                            <Upload className="w-5 h-5 text-DGXwhite" />
                                        </div>
                                    </>
                                ) : (
                            ...
                            <div className="flex-1">
                                ...
                                {newUnit.UnitImg && (
                                    <motion.button
                                        ...
                                        type="button"
                                        onClick={resetImage}
                                        className="mt-1 text-xs text-red-600 hover:text-red-800 transition flex items-center gap-1"
                                    >
                                        <X className="w-3 h-3" />
                                        Remove image
                                    </motion.button>
