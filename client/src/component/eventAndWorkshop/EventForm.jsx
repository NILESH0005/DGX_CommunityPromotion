        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                  errors.start ? "border-red-500 ring-red-500" : "border-gray-300"
                }`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="mb-4">
              ...
              <select
                name="categoryId"
                value={newEvent.categoryId || dropdownData.categoryOptions[0]?.ddValue || ""}
                onChange={handleChange}
                className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                  errors.categoryId ? "border-red-500 ring-red-500" : "border-gray-300"
                }`}
              >
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full p-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                errors.registerLink ? "border-red-500 ring-red-500" : "border-gray-300"
              }`}
              ref={registerLinkRef}
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Event Poster
              <span className="text-xs text-gray-500 ml-2">(Max size: 50KB | Formats: .jpeg, .png)</span>
            </label>
